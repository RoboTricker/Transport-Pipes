...
public class LocConf extends Conf {
	...
	public static final String FILTERING_FILTERBY_TYPE_DAMAGE = "filtering.filterby_type_damage";
	public static final String FILTERING_FILTERBY_TYPE_NBT = "filtering.filterby_type_nbt";
	public static final String FILTERING_FILTERBY_TYPE = "filtering.filterby_type";
	public static final String FILTERING_FILTERBY_TYPE_DAMAGE_NBT = "filtering.filterby_type_damage_nbt";
	public static final String FILTERING_BLOCKALL = "filtering.blockall";
	public static final String FILTERING_INVERT = "filtering.invert";
	public static final String FILTERING_CLICKTOCHANGE = "filtering.clicktochange";
	public static final String FILTERING_SCROLL_LEFT = "filtering.scroll.left";
	public static final String FILTERING_SCROLL_RIGHT = "filtering.scroll.right";
	...
	public LocConf() {
		...
		saveAsDefault(FILTERING_FILTERBY_TYPE, "&7Filter items by &cTYPE");
		saveAsDefault(FILTERING_FILTERBY_TYPE_DAMAGE, "&7Filter items by &cTYPE, DAMAGE");
		saveAsDefault(FILTERING_FILTERBY_TYPE_NBT, "&7Filter items by &cTYPE, ITEMMETA");
		saveAsDefault(FILTERING_FILTERBY_TYPE_DAMAGE_NBT, "&7Filter items by &cTYPE, DAMAGE, ITEMMETA");
		saveAsDefault(FILTERING_BLOCKALL, "&cBLOCK &7all items");
		saveAsDefault(FILTERING_INVERT, "&cINVERT &7filtered items");
		saveAsDefault(FILTERING_CLICKTOCHANGE, "&7Click to change filtering mode.");
		saveAsDefault(FILTERING_SCROLL_LEFT, "&6<<");
		saveAsDefault(FILTERING_SCROLL_RIGHT, "&6>>");
