...
public class ModelledPipeVOIDModel extends ModelledPipeModel {

	@Override
	public ArmorStandData createMidASD(ModelledPipeMidModelData data) {
		return new ArmorStandData(new RelLoc(0.5f, 0.5f - 1.1875f, 0.5f), new Vector(1, 0, 0), false, ITEM_HOE_MID_VOID, null, new Vector(180f, 0f, 0f), new Vector(0f, 0f, 0f));
	}
