package de.robotricker.transportpipes.rendersystem.pipe.modelled.model;
...
import de.robotricker.transportpipes.rendersystem.pipe.modelled.model.data.ModelledExtractionPipeConnectionModelData;
import de.robotricker.transportpipes.rendersystem.pipe.modelled.model.data.ModelledIronPipeConnectionModelData;
...
public class ModelledPipeModel {
    ...
    public ArmorStandData createConnASD(ModelledPipeConnectionModelData connModelData) {
        ...
        ArmorStandData asd;
        if (connModelData.getConnectionDir() == Direction.UP) {
        ...
        } else if (connModelData.getConnectionDir() == Direction.DOWN) {
