...
public class DuctService {
    ...
    public void register() {
        ...
        BaseDuctType.valueOf("Pipe").registerDuctType(new PipeType("Iron", item, "§7"), itemService);
        item = itemService.createSkullItemStack("f5fb2bb0-b743-3401-9508-141689682ed6", "", "");
        BaseDuctType.valueOf("Pipe").registerDuctType(new PipeType("Ice", item, "§b"), itemService);
        item = itemService.createSkullItemStack("b9871e6c-f129-3364-ad40-b41177032a91", "", "");
        BaseDuctType.valueOf("Pipe").registerDuctType(new PipeType("Void", item, "§5"), itemService);
        item = itemService.createSkullItemStack("e8501df6-3418-3470-afe3-723dd4a48186", "", "");
        BaseDuctType.valueOf("Pipe").registerDuctType(new PipeType("Extraction", item, "§d"), itemService);
        item = itemService.createSkullItemStack("2589f15a-2e13-4af3-b21c-3b1df42c98d0", "", "");
        BaseDuctType.valueOf("Pipe").registerDuctType(new PipeType("Crafting", item, "§e"), itemService);
        //ducttype connectables registration
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("White").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Blue").connectToAll().disconnectFromClasses(ColoredPipeType.class).connectTo("White", "Blue");
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Red").connectToAll().disconnectFromClasses(ColoredPipeType.class).connectTo("White", "Red");
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Yellow").connectToAll().disconnectFromClasses(ColoredPipeType.class).connectTo("White", "Yellow");
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Green").connectToAll().disconnectFromClasses(ColoredPipeType.class).connectTo("White", "Green");
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Black").connectToAll().disconnectFromClasses(ColoredPipeType.class).connectTo("White", "Black");
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Golden").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Iron").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Ice").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Void").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Extraction").connectToAll();
        BaseDuctType.valueOf("Pipe").ductTypeValueOf("Crafting").connectToAll();
    ...
    public List<RenderSystem> getRenderSystems(BaseDuctType baseDuctType) {
        synchronized (renderSystems) {
            return renderSystems.stream().filter(rs -> rs.getBaseDuctType().equals(baseDuctType)).collect(Collectors.toList());
        }
    }
